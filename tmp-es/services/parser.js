export const parseMarkdownToTasks = (markdown) => {
    if (!markdown.trim())
        return [];
    const tasks = [];
...
export const parseMarkdownToExplanationSections = (markdown) => {
    if (!markdown.trim())
        return [];
    const sections = [];
...
export const parseMarkdownToTaskSets = (markdown) => {
    if (!markdown.trim())
        return [];
    const taskSets = [];
...
export const parseMarkdownToLesson = (markdown) => {
